...
#         # 构造所有 async 任务
#         tasks = [
#             process_entity_construct(llm, entity, entity.sentence.text if entity.sentence else "", constructs, force)
#             for entity in entities if force or not entity.construct
#         ]
#
...
#                 logger.error(f"Construct mapping task raised an exception: {res}")
#
#         return JsonResponse({"classified_entities": updated}, status=200)
#
#     except json.JSONDecodeError:
